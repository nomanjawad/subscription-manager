...
/**
 * brand theme — built by `npx astryx theme build`
...
export const brandTheme = {
  ...
  tokens: {
    ...
    "--color-background-body": "light-dark(#F2EFF9, #121017)",
    "--color-background-card": "light-dark(#FDFBFF, #1C1B21)",
    "--color-background-popover": "light-dark(#FDFBFF, #312F36)",
    "--color-background-muted": "light-dark(#1C1B210D, #1C1B2180)",
    "--color-accent": "light-dark(#4F46E5, #7C74F2)",
    ...
    "--color-text-primary": "light-dark(#1C1B21, #E4E1EA)",
    "--color-text-secondary": "light-dark(#494551, #ADA9B7)",
    "--color-text-disabled": "light-dark(#938F9C, #605C69)",
    "--color-text-accent": "var(--color-accent)",
    "--color-on-dark": "#ffffff",
    "--color-on-light": "#171717",
    "--color-on-accent": "light-dark(#FFFFFF, #0016A8)",
    ...
    "--color-icon-primary": "light-dark(#1C1B21, #E4E1EA)",
    "--color-icon-secondary": "light-dark(#494551, #ADA9B7)",
    "--color-icon-disabled": "light-dark(#938F9C, #605C69)",
    ...
    "--color-border": "light-dark(#1C1B211A, #F2EFF91A)",
    "--color-border-emphasized": "light-dark(#ADA9B7, #494551)",
    "--color-skeleton": "light-dark(#ADA9B7, #494551)",
    ...
    "--color-track": "light-dark(#ADA9B7, #494551)",
    "--radius-chat": "42px"
  },
